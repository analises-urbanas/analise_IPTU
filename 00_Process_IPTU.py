...
# Exposta (em formato binário) o Schema por ano, contendo as tabelas e as vistas (views)
# Compacta os arquivos binários criados


# Exposta (em formato xls) cada uma das views

# Adiciona a planilha de filtro avançado no excel
